...
drivers/8231/%.o: ../drivers/8231/%.c
	...
	tc32-elf-gcc -ffunction-sections -fdata-sections -I"D:\Telink\1Firmware\telink_blackhawk_lighting_sdk" -D__PROJECT_LIGHT_BEACON__=1 -DCHIP_TYPE=CHIP_TYPE_8231 -Wall -O2 -fpack-struct -fshort-enums -finline-small-functions -std=gnu99 -fshort-wchar -fms-extensions -c -o "$@" "$<"
